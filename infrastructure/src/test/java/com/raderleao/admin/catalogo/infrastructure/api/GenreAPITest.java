...
import com.raderleao.admin.catalogo.application.genre.create.CreateGenreOutput;
...
import com.raderleao.admin.catalogo.application.genre.update.UpdateGenreOutput;
...
public class GenreAPITest {
    ...
    @Test
    public void givenAnInvalidNameCommand_whenCallsUpdateGenre_shouldReturnNotification() throws Exception {
        // given
        final String expectedName = null;
        final var expectedCategories = List.of("123", "456");
        final var expectedIsActive = true;
