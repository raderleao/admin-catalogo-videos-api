...
public class GenreTest {
    ...
    @Test
    public void givenInvalidEmpityName_whenCallNewGenreAndValidate_shouldReceiveAError() {
    ...
    @Test
    public void givenAnActiveGenre_whenCallDeactivete_shouldReceiveOK(){
        final var expectedName = "Açao";
    ...
    @Test
    public void givenAnInactiveGenre_whenCallActivete_shouldReceiveOK(){
        final var expectedName = "Açao";
        final var expectedIsActive = true;
        final var expectedCategories = 0;
    ...
    @Test
    public void givenAnVInvalidNullAsCategoryID_whenCallRemoveCategory_shouldReceiveOK() {
        final var seriesID = CategoryID.from("123");
        final var moviesID = CategoryID.from("456");
